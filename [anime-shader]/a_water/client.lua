...
local effectBias = dxCreateShader("effectBias.fx", 999, 0, false, "world")-- Apply depth bias to water effects to prevent flickering
if effectBias then
...
removeEventHandler("onClientRender", root, updateShaders)
if waterShader then
